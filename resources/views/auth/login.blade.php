                            ...
                            <div class="card-body p-4">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset('backend/assets/images/logodark.png')}}" alt="" height="22">
                                            </span>
                                        </a>
                    
                                        <a href="index.html" class="logo logo-light text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset('backend/assets/images/logolight.png')}}" alt="" height="22">
                                            </span>
                                        </a>
                                    </div>
                                ...
                                <form method="POST" action="{{ route('login') }}">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" name="login" type="text" id="login" required="" placeholder="Introduce tu correo electrónico" autofocus>
                                    </div>
